...
import { solution, solutionPart2 } from './solution'
...
describe('Day 4, Part 2', () => {
  it('should replicate subsequent cards when there is a match', () => {
    const mock = [
    ...
    const expected = 30
    assert.equal(solutionPart2(mock), expected)
  })

  it('should return a solution for the provide input', () => {
    const input = parseTxtToLines(INPUT_PATH)
    const actual = solutionPart2(input)
    assert.equal(actual, 9721255)
  })
})
